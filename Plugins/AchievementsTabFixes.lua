...
function achievementsTabFixes.InjectOptions()
    ...
    addon.InjectOptions:AddTable(pluginTable, "RenameExplorationDragonIslesCategory", {
        ...
        hidden = not addon.Util.IsDragonflightRetail
    });
end
...
function achievementsTabFixes.Load()
    if addon.Util.IsDragonflightRetail and addon.Options.db.profile.Plugins.AchievementsTabFixes.RenameExplorationDragonIslesCategory then
