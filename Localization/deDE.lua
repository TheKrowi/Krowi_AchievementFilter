...
L["Watch List"] = "Zu Fokus Filter hinzugefügt";
L["Gifts"] = "Geschenke";
...
L["More"] = "Mehr...";
L["Add to Watch List"] = "Fokus";
L["Remove from Watch List"] = "Fokus Filter löschen";
