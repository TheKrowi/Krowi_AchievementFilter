...
L["Auto-Hide Close Button"] = true
L["Auto-Hide Close Button Desc"] = "Only show the {popout}'s close button while mousing over it."
L["Auto-Hide Resize Button"] = true
L["Auto-Hide Resize Button Desc"] = "Only show the {popout}'s resize button while mousing over it."
...
L["Dragon Isle Drake Cosmetics"] = true
L["Dragon Isles"] = true
...
L["Enable Snapping Desc"] = "When dragging a popped-out achievement window close to another one, snap it into a stack below it. Moving or resizing the top of a stack moves/resizes the whole stack; moving or resizing any other window in the stack breaks it out."
L["Enable Tab Priority"] = true
L["Enable Tab Priority Desc"] = "Enable the tab priority feature."
L["Enable taint diagnostics"] = true
L["Enable taint diagnostics Desc"] = "Keep a small, capped diagnostic log in the Saved Variables to help track down the rare Lua taint errors mentioning this addon's name. Read-only, does not modify any game behavior."
...
L["Export Taint Diagnostics"] = true
L["Export Taint Diagnostics Desc"] = "Copy the diagnostic log collected for taint errors mentioning this addon's name. Share this if asked to when reporting such an error."
...
L["Fade Speed"] = true
L["Fade Speed Desc"] = "The time in seconds it takes for a {popout} to fade in or out when {fadeWhenNotHovered} is enabled. Lower values fade faster."
L["Fade When Not Hovered"] = true
L["Fade When Not Hovered Desc"] = "Fade a {popout} to the transparency below while it's not being moused over."
L["Faded Opacity"] = true
L["Faded Opacity Desc"] = "The transparency a {popout} fades to when {fadeWhenNotHovered} is enabled, with 0 being fully transparent and 1 being fully opaque."
...
L["Slagmire"] = true
L["Slayer's Rise"] = true
L["Snap Distance"] = true
L["Snap Distance Desc"] = "How close (in pixels) a dragged {popout} needs to be to another one before it snaps into a stack below it."
L["Snowstorms"] = true
L["Soon"] = true
