...
-- [[ Exported at 2024-01-16 17-56-33 ]] --
L["%c"] = true
L["%d/%m/%Y %I:%M %p"] = true
L["%m/%d/%Y %I:%M %p"] = true
L["%m/%d/%Y %R"] = true
...
L["Load Tracking Achievements Desc"] = "Charger les hauts faits suivis (Description)."
L["Loaded"] = "Chargé"
...
L["temporary obtainable"] = "temporairement obtenable"
