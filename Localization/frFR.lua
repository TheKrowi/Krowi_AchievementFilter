...
L["Nokhudon Hold"] = "L'offancive Nokhud";
L["Ohn'iri Springs"] = "Sources des Ohn'irs";
L["Brackenhide Hollow"] = "Creux des Fougerobes";
L["Cobalt Assembly"] = "L'assemblé du Cobalt";
L["Imbu"] = "Imbu";
L["Tyrhold"] = "Bastion de Tyr";
L["Dragonbane Keep"] = "Fléau-des-Dragons";
L["Slagmire"] = "Os de wyrmelin";
...
L["Dragonflight pre-patch - Firestorms"] = "0";
L["Dragonflight pre-patch - Sandstorms"] = "0";
L["Dragonflight pre-patch - Snowstorms"] = "0";
L["Dragonflight pre-patch - Thunderstorms"] = "0";
