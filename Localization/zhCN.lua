...
-- [[ Exported at 2024-03-20 19-54-26 ]] --
L["%c"] = true
L["%d/%m/%Y %I:%M %p"] = true
L["%m/%d/%Y %I:%M %p"] = true
L["%m/%d/%Y %R"] = true
...
L["tab"] = "标签页"
L["Tabs"] = "标签"
L["temporarily obtainable"] = "可获得"
L["Temporarily Obtainable Text"] = "{thisAchievement}{isWillBeWas}{startText}{startDetail}{endText}{endDetail}{neverOnceTempObt}"
