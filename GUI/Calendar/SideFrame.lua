...
KrowiAF_CalendarSideFrameMixin = {};
...
function KrowiAF_CalendarSideFrameMixin:BuildAchievementsScrollFrame()
...
function KrowiAF_CalendarSideFrameMixin:UpdateAchievements()
