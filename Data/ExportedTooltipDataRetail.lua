-- [[ Exported at 2022-11-11 00-08-05 ]] --
...
function exportedTooltipData.Load(d)
    ...
    AddD(d, 160986, tdt.Spell, 9502, 1, t[5], t[6]); -- "Blackrock Barbecue"
    AddD(d, 111449, tdt.Item, 9502, 1, t[5], t[6]); -- "Blackrock Barbecue"
    AddD(d, 118323, tdt.Item, 9502, 1, t[5], t[6]); -- "Blackrock Barbecue"
    AddD(d, 160962, tdt.Spell, 9502, 2, t[5], t[6]); -- "Blackrock Ham"
    AddD(d, 118311, tdt.Item, 9502, 2, t[5], t[6]); -- "Blackrock Ham"
    AddD(d, 111433, tdt.Item, 9502, 2, t[5], t[6]); -- "Blackrock Ham"
    AddD(d, 160968, tdt.Spell, 9502, 3, t[5], t[6]); -- "Braised Riverbeast"
    AddD(d, 111436, tdt.Item, 9502, 3, t[5], t[6]); -- "Braised Riverbeast"
    AddD(d, 118313, tdt.Item, 9502, 3, t[5], t[6]); -- "Braised Riverbeast"
    AddD(d, 160999, tdt.Spell, 9502, 4, t[5], t[6]); -- "Calamari Crepes"
    AddD(d, 111453, tdt.Item, 9502, 4, t[5], t[6]); -- "Calamari Crepes"
    AddD(d, 118326, tdt.Item, 9502, 4, t[5], t[6]); -- "Calamari Crepes"
    AddD(d, 111438, tdt.Item, 9502, 5, t[5], t[6]); -- "Clefthoof Sausages"
    AddD(d, 160971, tdt.Spell, 9502, 5, t[5], t[6]); -- "Clefthoof Sausages"
    AddD(d, 118315, tdt.Item, 9502, 5, t[5], t[6]); -- "Clefthoof Sausages"
    AddD(d, 111444, tdt.Item, 9502, 6, t[5], t[6]); -- "Fat Sleeper Cakes"
    AddD(d, 118319, tdt.Item, 9502, 6, t[5], t[6]); -- "Fat Sleeper Cakes"
    AddD(d, 160981, tdt.Spell, 9502, 6, t[5], t[6]); -- "Fat Sleeper Cakes"
    AddD(d, 111445, tdt.Item, 9502, 7, t[5], t[6]); -- "Fiery Calamari"
    AddD(d, 118320, tdt.Item, 9502, 7, t[5], t[6]); -- "Fiery Calamari"
    AddD(d, 160982, tdt.Spell, 9502, 7, t[5], t[6]); -- "Fiery Calamari"
    AddD(d, 160987, tdt.Spell, 9502, 8, t[5], t[6]); -- "Frosty Stew"
    AddD(d, 111450, tdt.Item, 9502, 8, t[5], t[6]); -- "Frosty Stew"
    AddD(d, 118324, tdt.Item, 9502, 8, t[5], t[6]); -- "Frosty Stew"
    AddD(d, 161000, tdt.Spell, 9502, 9, t[5], t[6]); -- "Gorgrond Chowder"
    AddD(d, 111454, tdt.Item, 9502, 9, t[5], t[6]); -- "Gorgrond Chowder"
    AddD(d, 118327, tdt.Item, 9502, 9, t[5], t[6]); -- "Gorgrond Chowder"
    AddD(d, 111441, tdt.Item, 9502, 10, t[5], t[6]); -- "Grilled Gulper"
    AddD(d, 118317, tdt.Item, 9502, 10, t[5], t[6]); -- "Grilled Gulper"
    AddD(d, 161002, tdt.Spell, 9502, 11, t[5], t[6]); -- "Grilled Saberfish"
    AddD(d, 111456, tdt.Item, 9502, 11, t[5], t[6]); -- "Grilled Saberfish"
    AddD(d, 111431, tdt.Item, 9502, 12, t[5], t[6]); -- "Hearty Elekk Steak"
    AddD(d, 118310, tdt.Item, 9502, 12, t[5], t[6]); -- "Hearty Elekk Steak"
    AddD(d, 160958, tdt.Spell, 9502, 12, t[5], t[6]); -- "Hearty Elekk Steak"
    AddD(d, 160966, tdt.Spell, 9502, 13, t[5], t[6]); -- "Pan-Seared Talbuk"
    AddD(d, 111434, tdt.Item, 9502, 13, t[5], t[6]); -- "Pan-Seared Talbuk"
    AddD(d, 118312, tdt.Item, 9502, 13, t[5], t[6]); -- "Pan-Seared Talbuk"
    AddD(d, 111437, tdt.Item, 9502, 14, t[5], t[6]); -- "Rylak Crepes"
    AddD(d, 118314, tdt.Item, 9502, 14, t[5], t[6]); -- "Rylak Crepes"
    AddD(d, 160969, tdt.Spell, 9502, 14, t[5], t[6]); -- "Rylak Crepes"
    AddD(d, 111455, tdt.Item, 9502, 15, t[5], t[6]); -- "Saberfish Broth"
    AddD(d, 161001, tdt.Spell, 9502, 15, t[5], t[6]); -- "Saberfish Broth"
    AddD(d, 111446, tdt.Item, 9502, 16, t[5], t[6]); -- "Skulker Chowder"
    AddD(d, 118321, tdt.Item, 9502, 16, t[5], t[6]); -- "Skulker Chowder"
    AddD(d, 160983, tdt.Spell, 9502, 16, t[5], t[6]); -- "Skulker Chowder"
    AddD(d, 160989, tdt.Spell, 9502, 17, t[5], t[6]); -- "Sleeper Surprise"
    AddD(d, 111452, tdt.Item, 9502, 17, t[5], t[6]); -- "Sleeper Surprise"
    AddD(d, 118325, tdt.Item, 9502, 17, t[5], t[6]); -- "Sleeper Surprise"
    AddD(d, 111439, tdt.Item, 9502, 18, t[5], t[6]); -- "Steamed Scorpion"
    AddD(d, 118316, tdt.Item, 9502, 18, t[5], t[6]); -- "Steamed Scorpion"
    AddD(d, 160973, tdt.Spell, 9502, 18, t[5], t[6]); -- "Steamed Scorpion"
    AddD(d, 118318, tdt.Item, 9502, 19, t[5], t[6]); -- "Sturgeon Stew"
    AddD(d, 111442, tdt.Item, 9502, 19, t[5], t[6]); -- "Sturgeon Stew"
    AddD(d, 160979, tdt.Spell, 9502, 19, t[5], t[6]); -- "Sturgeon Stew"
    AddD(d, 111447, tdt.Item, 9502, 20, t[5], t[6]); -- "Talador Surf and Turf"
    AddD(d, 118322, tdt.Item, 9502, 20, t[5], t[6]); -- "Talador Surf and Turf"
    AddD(d, 160984, tdt.Spell, 9502, 20, t[5], t[6]); -- "Talador Surf and Turf"
