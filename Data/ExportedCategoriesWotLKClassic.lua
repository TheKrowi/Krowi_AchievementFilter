-- [[ Exported at 2022-08-10 14-05-11 ]] --
...
function exportedCategories.Load(a)
    ...
    tmp[4] = cat:New((addon.EJ_GetInstanceInfo(63))); -- Deadmines
    AddC(tmp[2], tmp[4]);
    ...
    tmp[9] = cat:New((addon.EJ_GetInstanceInfo(64))); -- Shadowfang Keep
    AddC(tmp[2], tmp[9]);
    ...
    tmp[15] = cat:New((addon.EJ_GetInstanceInfo(311))); -- Scarlet Halls
    AddC(tmp[2], tmp[15]);
    ...
    tmp[16] = cat:New((addon.EJ_GetInstanceInfo(316))); -- Scarlet Monastery
    AddC(tmp[2], tmp[16]);
    ...
    tmp[797] = cat:New((addon.EJ_GetInstanceInfo(559))); -- Upper Blackrock Spire
    AddC(tmp[2], tmp[797]);
    ...
    tmp[24] = cat:New((addon.EJ_GetInstanceInfo(246))); -- Scholomance
    AddC(tmp[2], tmp[24]);
    ...
    tmp[28] = cat:New((addon.EJ_GetInstanceInfo(76))); -- Zul'Gurub
    AddC(tmp[3], tmp[28]);
    ...
    tmp[81] = cat:New((addon.EJ_GetInstanceInfo(77))); -- Zul'Aman
    AddC(tmp[73], tmp[81]);
