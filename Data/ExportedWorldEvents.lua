-- [[ Exported at 2022-12-26 23-20-47 ]] --
...
function exportedWorldEvents.Load(e)
    ...
    e[7220] = event:New(7220, 4240492, addon.L["Community Feast: Ready"], 2024, 3600); -- Community Feast: Ready
    e[7221] = event:New(7221, 4554434, addon.L["Nokhudon Hold"], 2023, 5400); -- Nokhudon Hold
    e[7222] = event:New(7222, 4554437, addon.L["Nokhudon Hold"], 2023, 5400); -- Nokhudon Hold
    e[7223] = event:New(7223, 4554438, addon.L["Nokhudon Hold"], 2023, 5400); -- Nokhudon Hold
    e[7224] = event:New(7224, 4554439, addon.L["Nokhudon Hold"], 2023, 5400); -- Nokhudon Hold
    e[7225] = event:New(7225, 4554434, addon.L["Ohn'iri Springs"], 2023, 5400); -- Ohn'iri Springs
    e[7226] = event:New(7226, 4554437, addon.L["Ohn'iri Springs"], 2023, 5400); -- Ohn'iri Springs
    e[7227] = event:New(7227, 4554438, addon.L["Ohn'iri Springs"], 2023, 5400); -- Ohn'iri Springs
    e[7228] = event:New(7228, 4554439, addon.L["Ohn'iri Springs"], 2023, 5400); -- Ohn'iri Springs
    e[7229] = event:New(7229, 4554434, addon.L["Brackenhide Hollow"], 2024, 5400); -- Brackenhide Hollow
    e[7230] = event:New(7230, 4554437, addon.L["Brackenhide Hollow"], 2024, 5400); -- Brackenhide Hollow
    e[7231] = event:New(7231, 4554438, addon.L["Brackenhide Hollow"], 2024, 5400); -- Brackenhide Hollow
    e[7232] = event:New(7232, 4554439, addon.L["Brackenhide Hollow"], 2024, 5400); -- Brackenhide Hollow
    e[7233] = event:New(7233, 4554434, addon.L["Cobalt Assembly"], 2024, 5400); -- Cobalt Assembly
    e[7234] = event:New(7234, 4554437, addon.L["Cobalt Assembly"], 2024, 5400); -- Cobalt Assembly
    e[7235] = event:New(7235, 4554438, addon.L["Cobalt Assembly"], 2024, 5400); -- Cobalt Assembly
    e[7236] = event:New(7236, 4554439, addon.L["Cobalt Assembly"], 2024, 5400); -- Cobalt Assembly
    e[7237] = event:New(7237, 4554434, addon.L["Imbu"], 2024, 5400); -- Imbu
    e[7238] = event:New(7238, 4554437, addon.L["Imbu"], 2024, 5400); -- Imbu
    e[7239] = event:New(7239, 4554438, addon.L["Imbu"], 2024, 5400); -- Imbu
    e[7240] = event:New(7240, 4554439, addon.L["Imbu"], 2024, 5400); -- Imbu
    e[7245] = event:New(7245, 4554434, addon.L["Tyrhold"], 2025, 5400); -- Tyrhold
    e[7246] = event:New(7246, 4554437, addon.L["Tyrhold"], 2025, 5400); -- Tyrhold
    e[7247] = event:New(7247, 4554438, addon.L["Tyrhold"], 2025, 5400); -- Tyrhold
    e[7248] = event:New(7248, 4554439, addon.L["Tyrhold"], 2025, 5400); -- Tyrhold
    e[7249] = event:New(7249, 4554434, addon.L["Dragonbane Keep"], 2022, 5400); -- Dragonbane Keep
    e[7250] = event:New(7250, 4554437, addon.L["Dragonbane Keep"], 2022, 5400); -- Dragonbane Keep
    e[7251] = event:New(7251, 4554438, addon.L["Dragonbane Keep"], 2022, 5400); -- Dragonbane Keep
    e[7252] = event:New(7252, 4554439, addon.L["Dragonbane Keep"], 2022, 5400); -- Dragonbane Keep
    e[7253] = event:New(7253, 4554434, addon.L["Slagmire"], 2022, 5400); -- Slagmire
    e[7254] = event:New(7254, 4554437, addon.L["Slagmire"], 2022, 5400); -- Slagmire
    e[7255] = event:New(7255, 4554438, addon.L["Slagmire"], 2022, 5400); -- Slagmire
    e[7256] = event:New(7256, 4554439, addon.L["Slagmire"], 2022, 5400); -- Slagmire
    e[7257] = event:New(7257, 4554434, addon.L["Scalecracker Keep"], 2022, 5400); -- Scalecracker Keep
    e[7258] = event:New(7258, 4554437, addon.L["Scalecracker Keep"], 2022, 5400); -- Scalecracker Keep
    e[7259] = event:New(7259, 4554438, addon.L["Scalecracker Keep"], 2022, 5400); -- Scalecracker Keep
    e[7260] = event:New(7260, 4554439, addon.L["Scalecracker Keep"], 2022, 5400); -- Scalecracker Keep
    e[7267] = event:New(7267, 1394891, addon.L["Siege on Dragonbane Keep: Gathering"], 2022, 3600); -- Siege on Dragonbane Keep: Gathering
    e[7298] = event:New(7298, 4554434, addon.L["Primalist Tomorrow"], 2025, 5400); -- Primalist Tomorrow
    e[7299] = event:New(7299, 4554437, addon.L["Primalist Tomorrow"], 2025, 5400); -- Primalist Tomorrow
    e[7300] = event:New(7300, 4554438, addon.L["Primalist Tomorrow"], 2025, 5400); -- Primalist Tomorrow
    e[7301] = event:New(7301, 4554439, addon.L["Primalist Tomorrow"], 2025, 5400); -- Primalist Tomorrow
