-- [[ Exported at 2022-05-29 10-30-22 ]] --
...
function exportedWorldEvents.LoadCategories(e, a)
    ...
    e[5175].Category = addon.Tabs["Events"].Categories[5].Children[1]; -- Legion Assaults
    e[5177].Category = addon.Tabs["Events"].Categories[5].Children[1]; -- Legion Assaults
    e[5178].Category = addon.Tabs["Events"].Categories[5].Children[1]; -- Legion Assaults
    e[5210].Category = addon.Tabs["Events"].Categories[5].Children[1]; -- Legion Assaults
    e[5896].Category = addon.Tabs["Events"].Categories[6].Children[1].Children[1]; -- Assault on Tiragarde Sound
    e[5964].Category = addon.Tabs["Events"].Categories[6].Children[1].Children[2]; -- Assault on Drustvar
    e[5966].Category = addon.Tabs["Events"].Categories[6].Children[1].Children[3]; -- Assault on Stormsong Valley
    e[5969].Category = addon.Tabs["Events"].Categories[6].Children[1].Children[5]; -- Assault on Nazmir
    e[5970].Category = addon.Tabs["Events"].Categories[6].Children[1].Children[6]; -- Assault on Vol'dun
    e[5973].Category = addon.Tabs["Events"].Categories[6].Children[1].Children[4]; -- Assault on Zuldazar
    e[6486].Category = addon.Tabs["Events"].Categories[6].Children[2].Children[2]; -- Uldum
    e[6487].Category = addon.Tabs["Events"].Categories[6].Children[2].Children[2]; -- Uldum
    e[6488].Category = addon.Tabs["Events"].Categories[6].Children[2].Children[2]; -- Uldum
    e[6489].Category = addon.Tabs["Events"].Categories[6].Children[2].Children[1]; -- Vale of Eternal Blossoms
    e[6490].Category = addon.Tabs["Events"].Categories[6].Children[2].Children[1]; -- Vale of Eternal Blossoms
    e[6491].Category = addon.Tabs["Events"].Categories[6].Children[2].Children[1]; -- Vale of Eternal Blossoms
    e[6989].Category = addon.Tabs["Events"].Categories[7].Children[1].Children[2]; -- Necrolords Assault
    e[6990].Category = addon.Tabs["Events"].Categories[7].Children[1].Children[4]; -- Venthyr Assault
    e[6991].Category = addon.Tabs["Events"].Categories[7].Children[1].Children[1]; -- Kyrian Assault
    e[6992].Category = addon.Tabs["Events"].Categories[7].Children[1].Children[3]; -- Night Fae Assault
end
...
function exportedWorldEvents.InjectOptions()
    ...
    addon.Options.InjectOptionsTable(optionsTable, "WorldEvents", "EventReminders", "args", "Events", "args");
end
