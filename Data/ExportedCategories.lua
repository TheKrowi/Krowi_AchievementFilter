...
function exportedCategories.Load(a)
    ...
    tmp[1164] = cat:New((GetCategoryInfo(15270))); -- Player vs. Player
    ...
    tmp[1138] = cat:New((GetCategoryInfo(14901))); -- Wintergrasp
    ...
    tmp[500] = cat:New(addon.GetMapName(417) .. " (" .. (GetCategoryInfo(15234)) .. ")"); -- Temple of Kotmogu
    ...
    tmp[1036] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[1037] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[1038] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    ...
    tmp[1168] = cat:New((GetCategoryInfo(92))); -- Character
    ...
    tmp[1159] = cat:New((GetCategoryInfo(15447))); -- Quests
    ...
    tmp[1161] = cat:New((GetCategoryInfo(97))); -- Exploration
    ...
    tmp[1150] = cat:New((GetCategoryInfo(14864))); -- Classic
    ...
    tmp[1151] = cat:New((GetCategoryInfo(14865))); -- The Burning Crusade
    ...
    tmp[1152] = cat:New((GetCategoryInfo(14866))); -- Wrath of the Lich King
    ...
    tmp[1153] = cat:New((GetCategoryInfo(15072))); -- Cataclysm
    ...
    tmp[1154] = cat:New((GetCategoryInfo(15164))); -- Mists of Pandaria
    ...
    tmp[1155] = cat:New((GetCategoryInfo(15233))); -- Warlords of Dreanor
    ...
    tmp[1156] = cat:New((GetCategoryInfo(15258))); -- Legion
    ...
    tmp[1157] = cat:New((GetCategoryInfo(15305))); -- Battle for Azeroth
    ...
    tmp[1158] = cat:New((GetCategoryInfo(15439))); -- Shadowlands
    ...
    tmp[1163] = cat:New((GetCategoryInfo(15273))); -- Reputation
    ...
    tmp[1171] = cat:New((GetCategoryInfo(15246))); -- Collections
    ...
    tmp[1172] = cat:New((GetCategoryInfo(81))); -- Feats of Strength
    ...
    tmp[1167] = cat:New((GetCategoryInfo(15266))); -- Honor
    ...
    tmp[1165] = cat:New((GetCategoryInfo(153))); -- Battlegrounds
    ...
    tmp[1166] = cat:New((GetCategoryInfo(165))); -- Arena
    ...
    tmp[1131] = cat:New((GetCategoryInfo(14864))); -- Classic
    ...
    tmp[1199] = cat:New((GetCategoryInfo(14865))); -- The Burning Crusade
    ...
    tmp[1200] = cat:New((GetCategoryInfo(14866))); -- Wrath of the Lich King
    ...
    tmp[1197] = cat:New((GetCategoryInfo(15072))); -- Cataclysm
    ...
    tmp[1198] = cat:New((GetCategoryInfo(15164))); -- Mists of Pandaria
    ...
    tmp[1175] = cat:New((GetCategoryInfo(15233))); -- Warlords of Dreanor
    ...
    tmp[1180] = cat:New((GetCategoryInfo(15258))); -- Legion
    ...
    tmp[1192] = cat:New((GetCategoryInfo(15305))); -- Battle for Azeroth
    ...
    tmp[1187] = cat:New((GetCategoryInfo(15439))); -- Shadowlands
    ...
    tmp[1047] = cat:New((GetCategoryInfo(14866))); -- Wrath of the Lich King
    AddC(tmp[1043], tmp[1047]);
    tmp[1054] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    ...
    tmp[1057] = cat:New((GetCategoryInfo(15272)), true); -- Dungeons
    AddC(tmp[1047], tmp[1057]);
    AddA(tmp[1057], a[9058]); -- Leeeeeeeeeeeeeroy...?
    tmp[1056] = cat:New((GetCategoryInfo(15271)), true); -- Raids
    ...
    tmp[1048] = cat:New((GetCategoryInfo(15072))); -- Cataclysm
    AddC(tmp[1043], tmp[1048]);
    AddA(tmp[1048], a[5767]); -- Scourer of the Eternal Sands
    tmp[1058] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    AddC(tmp[1048], tmp[1058]);
    AddA(tmp[1058], a[5879]); -- Veteran of the Molten Front
    tmp[1059] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[1048], tmp[1059]);
    AddA(tmp[1059], a[5827]); -- Avengers of Hyjal
    tmp[1060] = cat:New((GetCategoryInfo(15271)), true); -- Raids
    ...
    tmp[1049] = cat:New((GetCategoryInfo(15164))); -- Mists of Pandaria
    AddC(tmp[1043], tmp[1049]);
    tmp[1061] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[1062] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[1049], tmp[1062]);
    AddA(tmp[1062], a[6544]); -- The Tillers
    AddA(tmp[1062], a[8023]); -- Wakener
    tmp[1063] = cat:New((GetCategoryInfo(15271)), true); -- Raids
    ...
    tmp[1050] = cat:New((GetCategoryInfo(15233))); -- Warlords of Dreanor
    AddC(tmp[1043], tmp[1050]);
    tmp[1066] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[1067] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    ...
    tmp[1068] = cat:New((GetCategoryInfo(15271)), true); -- Raids
    ...
    tmp[1052] = cat:New((GetCategoryInfo(15305))); -- Battle for Azeroth
    AddC(tmp[1043], tmp[1052]);
    tmp[1075] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[1076] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[1077] = cat:New((GetCategoryInfo(15271)), true); -- Raids
    ...
    tmp[1078] = cat:New((GetCategoryInfo(15417)), true); -- Heart of Azeroth
    AddC(tmp[1052], tmp[1078]);
    AddA(tmp[1078], a[13779]); -- Phenomenal Cosmic Power
    tmp[1079] = cat:New((GetCategoryInfo(15426)), true); -- Visions of N'Zoth
    AddC(tmp[1052], tmp[1079]);
    AddA(tmp[1079], a[14140]); -- Mad World
    tmp[1053] = cat:New((GetCategoryInfo(15439))); -- Shadowlands
    AddC(tmp[1043], tmp[1053]);
    tmp[1080] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    AddC(tmp[1053], tmp[1080]);
    AddA(tmp[1080], a[14277]); -- The Accuser's Avowed
    tmp[1081] = cat:New((GetCategoryInfo(15271)), true); -- Raids
    ...
    tmp[1082] = cat:New((GetCategoryInfo(15440)), true); -- Torghast
    AddC(tmp[1053], tmp[1082]);
    AddA(tmp[1082], a[14568]); -- Twisting Corridors: Layer 6
    tmp[1083] = cat:New((GetCategoryInfo(15441)), true); -- Covenant Sanctums
    ...
    tmp[1085] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    AddC(tmp[1084], tmp[1085]);
    AddA(tmp[1085], a[978]); -- 3000 Quests Completed
    AddA(tmp[1085], a[7520]); -- The Loremaster
    tmp[1086] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[1088] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    ...
    tmp[1087] = cat:New((GetCategoryInfo(15272)), true); -- Dungeons
    AddC(tmp[1084], tmp[1087]);
    AddA(tmp[1087], a[4477]); -- Looking For Many
    tmp[1089] = cat:New((GetCategoryInfo(15117)), true); -- Pet Battles
    ...
    tmp[1090] = cat:New(addon.L["Brawler's Guild"] .. " (" .. (GetCategoryInfo(15234)) .. ")", true); -- Brawler's Guild
    AddC(tmp[1084], tmp[1090]);
    AddA(tmp[1090], a[13191]); -- Brawler for Azeroth
    tmp[1091] = cat:New((GetCategoryInfo(15246)), true); -- Collections
    ...
    tmp[1092] = cat:New((GetCategoryInfo(169)), true); -- Professions
    ...
    tmp[1093] = cat:New((GetCategoryInfo(15270)), true); -- PvP
    AddC(tmp[1084], tmp[1093]);
    tmp[1096] = cat:New((GetCategoryInfo(15266)), true); -- Honor
    ...
    tmp[1095] = cat:New((GetCategoryInfo(15283)), true); -- World
    ...
    tmp[1098] = cat:New((GetCategoryInfo(153)), true); -- Battlegrounds
    ...
    tmp[1102] = cat:New((GetCategoryInfo(15246))); -- Collections
    ...
    tmp[1103] = cat:New((GetCategoryInfo(15271))); -- Raids
    ...
    tmp[1104] = cat:New((GetCategoryInfo(15270))); -- Player vs. Player
    ...
    tmp[1110] = cat:New((GetCategoryInfo(169))); -- Professions
    ...
    tmp[1117] = cat:New((GetCategoryInfo(15268))); -- Promotions
