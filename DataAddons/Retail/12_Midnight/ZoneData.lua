...
zoneData:Zone(2556, { -- Nexus-Point Xenas (dungeon) [CHECK MAP IDS - MAY BE INACCURATE]
...
zoneData:Zone({2572, 2573, 2574}, { -- Voidscar Arena (dungeon) [CHECK MAP IDS - MAY BE INACCURATE]
